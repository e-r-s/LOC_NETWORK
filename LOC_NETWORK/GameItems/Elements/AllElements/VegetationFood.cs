...
{
    public class VegetationFood:Element
    {
        public VegetationFood()
        {

            this.TypeOfElement = ElementType.None;
            this.Name = "VegetationFood";
            ...
            this.Elements = new ElementContent[]{
                   ...
                   new ElementContent( AllBaseElements.Carbohydrate, 40 ),
                   new ElementContent( AllBaseElements.Protein, 5 ),
                   new ElementContent( AllBaseElements.Vitamin, 10 ),
                   new ElementContent( AllBaseElements.Water, 25 ),
